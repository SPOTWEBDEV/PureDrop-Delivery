            ...
            <div class="auto-container">
                <div class="inner-box">
                    ...
                    <div class="content-box">
                        <h2>Ensure Clean and Safe Water for a Healthier Life</h2>
                        <p>Your health matters, and so does the water you drink. We provide pure and safe water for a better lifestyle.</p>
                        <div class="btn-box clearfix">
                            <a href="service.html" class="theme-btn btn-one">Explore Our Services</a>
                            <a href="service.html" class="theme-btn banner-btn">Learn More</a>
                        </div>
                    </div>
                </div> 
            </div>
    ...
    <div class="auto-container">
        <div class="inner-container wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
            <div class="title-text">
                <h2>Your Trusted Partner in <br />Premium Water Delivery</h2>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h4>Pure & Clean</h4>
                            <p>Our water goes through advanced filtration processes to guarantee the highest level of purity for your well-being.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h4>Free from Harmful Chemicals</h4>
                            <p>Our water is free of chlorine and other harmful substances, ensuring it remains fresh and safe for consumption.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h4>5-Stage Filtration</h4>
                            <p>Each drop of water undergoes a comprehensive 5-stage filtration process, ensuring superior quality and taste.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                    <div class="feature-block-one">
                        <div class="inner-box">
                            ...
                            <h4>Stay Hydrated</h4>
                            <p>Stay refreshed and energized with clean water that supports your health and hydration needs throughout the day.</p>
                        </div>
                    </div>  
                </div>
            </div>
    ...
    <div class="auto-container">
        <div class="content-box">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 title-column">
                    <div class="sec-title">
                        <h2>Your Source for Pure, Safe Drinking Water for a Healthier Life.</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 text-column">
                    <div class="text">
                        <p>Our mission is to provide high-quality, purified drinking water to support your health and wellness. Through advanced filtration methods, we remove contaminants to ensure each drop is safe and refreshing.</p>
                        <p>With our commitment to quality, we offer water that meets the highest safety standards. Stay hydrated and improve your quality of life with our trustworthy water delivery service.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="video-inner">
            <div class="inner-box" style="background-image: url(assets/images/background/video-1.jpg);">
                <div class="video-btn">
                    <a href="https://www.youtube.com/watch?v=nfP5N9Yc72A&amp;t=28s" class="lightbox-image" data-caption=""></i></a>
                </div>
            </div>
        </div>
    </div>
...
<!-- about-style-two end -->
            ...
            <!-- shop-section end -->
        <!-- shop-section -->
        <section class="shop-section centred pt-145" id="about">
    <div class="auto-container">
        <div class="sec-title">
            <h2>We Deliver the Best Quality <br />Bottled Water Packs.</h2>
        </div>
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6 col-sm-12 shop-block">
                <div class="shop-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500m">
                    <div class="inner-box" id="cart-1">
                        ...
                        <div class="lower-content">
                            <div class="shape" style="background-image: url(assets/images/shape/shape-7.png);"></div>
                            <span>2L, 3 Bottles</span>
                            <h4><a href="shop-details.html">Premium Mineral Water Bottle</a></h4>
                            <h6>$<span>70.00</span></h6>
                            <p>Enjoy pure and refreshing water with our premium 2L bottles. Perfect for hydration on the go.</p>
                            <div class="btn-box">
                                <button class="theme-btn btn-two addcart">Add to cart</button>
                            </div>
                        </div>
                ...
                <div class="shop-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500m">
                    <div class="inner-box" id="cart-2">
                        ...
                        <div class="lower-content">
                            ...
                            <h4><a href="shop-details.html">Premium Mineral Water Bottle</a></h4>
                            <h6>$<span>60.00</span></h6>
                            <p>Stay hydrated with our refreshing 3L bottles, ideal for families and events.</p>
                            <div class="btn-box">
                                 <button class="theme-btn btn-two addcart">Add to cart</button>
                            </div>
                        </div>
                ...
                <div class="shop-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500m">
                    <div class="inner-box" id="cart-3">
                        ...
                        <div class="lower-content">
                            ...
                            <h4><a href="shop-details.html">Premium Mineral Water Bottle</a></h4>
                            <h6>$<span>55.00</span></h6>
                            <p>Get the purest water delivered in convenient 3L bottles, designed for lasting freshness.</p>
                            <div class="btn-box">
                                <button class="theme-btn btn-two addcart">Add to cart</button>
                            </div>
                        </div>
        ...
        <div class="row align-items-center clearfix">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                <div class="content_block_4">
                    <div class="content-box">
                        <div class="sec-title">
                            <h2>Experience the Best Water Delivery Service Today!</h2>
                        </div>
                        <div class="text">
                            <p>We proudly serve customers across 10+ countries, providing fast and reliable water delivery to your home or office, with delivery times as quick as 2 hours anywhere in the city.</p>
                        </div>
                        <ul class="list clearfix">
                            <li>Free Delivery</li>
                            <li>Available 7 Days a Week</li>
...
<section class="testimonial-section alternat-2 bg-color-1">
    ...
    <div class="auto-container">
        <div class="sec-title centred light">
            <h2>What Our Customers Are Saying <br />About <span><?php echo $sitename; ?></span></h2>
        </div>
        <div class="two-column-carousel owl-carousel owl-theme owl-nav-none">
            <div class="testimonial-block-one">
                <div class="inner-box">
                    ...
                    <div class="inner">
                        ...
                        <p>The water quality is top-notch, and the deliveries are always prompt. I highly recommend this service!</p>
                        <h5>Nicolas Lawson</h5>
            ...
            <div class="testimonial-block-one">
                <div class="inner-box">
                    ...
                    <div class="inner">
                        ...
                        <p>Great service with clean, fresh water delivered directly to my doorstep. I couldn’t be more satisfied!</p>
                        <h5>Michael Bean</h5>
...
<!-- testimonial-section end -->
            ...
            <!-- contact-section end -->
        <!-- contact-section -->
        <section class="contact-section bg-color-1" id="contact">
            <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-23.png);"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 title-column">
    <div class="title-inner">
        <div class="sec-title">
            <h2>Get a Free Quote and Build Your Ideal Business.</h2>
        </div>
        <div class="text">
            <p>We provide tailored solutions to help you create and grow the business of your dreams. Let us help you take the next step toward success with expert advice and support.</p>
        </div>
    </div>
</div>
...
<section class="news-section">
    <div class="auto-container">
        <div class="sec-title centred">
            <h2>Stay Informed with <br />DrinkPure</h2>
        </div>
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500m">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <div class="category"><a href="blog-details.html">Water Safety</a></div>
                            <h4><a href="blog-details.html">How to Maintain Safe and Clean Drinking Water</a></h4>
                            <ul class="post-info clearfix">
                                <li><a href="blog-details.html">John Doe</a></li>
                                <li>Jan 05, 2025</li>
                            </ul>
                            <div class="text">
                                <p>Learn practical tips for ensuring water safety at home and the importance of purified water for your health.</p>
                            </div>
                            <div class="btn-box">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500m">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <div class="category"><a href="blog-details.html">Water Supply</a></div>
                            <h4><a href="blog-details.html">Ensuring Consistent Water Quality for All</a></h4>
                            <ul class="post-info clearfix">
                                <li><a href="blog-details.html">Jane Smith</a></li>
                                <li>Jan 02, 2025</li>
                            </ul>
                            <div class="text">
                                <p>Explore the robust processes and cutting-edge technology we use to ensure every drop of water meets the highest standards.</p>
                            </div>
                            <div class="btn-box">
                                <a href="blog-details.html" class="theme-btn btn-two">Read More</a>
                            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500m">
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            <div class="category"><a href="blog-details.html">Community</a></div>
                            <h4><a href="blog-details.html">Our Efforts to Bring Clean Water to Underserved Communities</a></h4>
                            <ul class="post-info clearfix">
                                <li><a href="blog-details.html">Michael Johnson</a></li>
                                <li>Dec 30, 2024</li>
                            </ul>
                            <div class="text">
                                <p>Learn about our ongoing initiatives to provide access to clean water for communities in need.</p>
                            </div>
                            <div class="btn-box">
                                <a href="blog-details.html" class="theme-btn btn-two">Read More</a>
                            </div>
