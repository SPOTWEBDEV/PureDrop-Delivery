        ...
        <div class="dashboard-main-body">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
                ...
                <ul class="flex items-center gap-[6px]">
                    ...
                    <li class="font-medium dark:text-white">Product List Page</li>
                </ul>
            </div>
                ...
                <div class="lg:col-span-12 2xl:col-span-6">
                    <div class="card h-full border-0 overflow-hidden">
                        <div
                            ...
                            <h6 class="text-lg font-semibold mb-0">Product List
                            </h6>
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Date Product Added</th>
                                    ...
                                    <tbody>
                                        ...
                                        $select_user = mysqli_query($connection, "SELECT * FROM `products` WHERE id='$user_id'");
