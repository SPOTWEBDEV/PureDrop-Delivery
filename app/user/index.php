                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($select_user) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($select_user)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            <span class="bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 px-6 py-1.5 rounded-full font-medium text-sm">In-Active</span>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row['date'] ?>
                                            ...
                                            <p style="color:red">Table is Empty</p>
                                        <?php } ?>
