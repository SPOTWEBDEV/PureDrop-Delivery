        ...
        <div class="dashboard-main-body">
            ...
            <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
                ...
                <ul class="flex items-center gap-[6px]">
                    ...
                    <li class="font-medium dark:text-white">Contact Page</li>
                </ul>
            </div>
                ...
                <div class="lg:col-span-12 2xl:col-span-6">
                    <div class="card h-full border-0 overflow-hidden">
                        <div
                            ...
                            <h6 class="text-lg font-semibold mb-0">All Complaint
                            </h6>
                            ...
                            <div class="table-responsive scroll-sm">
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        $select_user = mysqli_query($connection, "SELECT * FROM `contact` WHERE id='$user_id'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($row['status'] == 'read') { ?>
                                                            ...
                                                            <span class="bg-success-100 dark:bg-danger-600/25 text-success-600 dark:text-success-400 px-6 py-1.5 rounded-full font-medium text-sm">Read</span>
                                                        <?php } else { ?>
                                                            <span
                                                                class="bg-danger-100 dark:bg-danger-600/25 text-danger-600 dark:text-danger-400 px-6 py-1.5 rounded-full font-medium text-sm">Not-Resolve</span>
