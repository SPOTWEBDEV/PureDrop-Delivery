                                                      ...
                                                      <div class="flex flex-wrap items-center gap-3">
                                                               ...
                                                               <div class="hidden sm:inline-block">
                                                                        <button data-dropdown-toggle="dropdownInformation"
                                                                                 ...
                                                                                 type="button">
                                                                                 <img src="<?php echo $domain ?>assets/images/lang-flag.png"
                                                                                          alt="image"
                                                                        ...
                                                                        <div id="dropdownInformation"
                                                                                 ...
                                                                                 <div
                                                                                          ...
                                                                                          <div>
                                                                                                   <h6
                                                                                                            class="text-lg text-neutral-900 font-semibold mb-0">
                                                                                                            Choose Your
                                                                                                            Language
                                                                                                   </h6>
                                                                                          </div>
                                                                                 ...
                                                                                 <div
                                                                                          ...
                                                                                          <div
                                                                                                   ...
                                                                                                   <div
                                                                                                            class="form-check style-check flex items-center justify-between">
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              ...
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag1.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">English</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                                     type="radio"
                                                                                                                     id="english">
                                                                                                   </div>
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag2.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">Japan</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag3.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">Franch</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag4.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">Germany</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag5.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">South
                                                                                                                                       Koria</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag6.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">Bangladesh</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag7.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">India</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <label class="form-check-label line-height-1 font-medium text-secondary-light"
                                                                                                                     ...
                                                                                                                     <span
                                                                                                                              class="text-black hover-bXg-transparent hover-text-primary flex items-center gap-3">
                                                                                                                              <img src="<?php echo $domain ?>assets/images/flags/flag8.png"
                                                                                                                                       alt=""
                                                                                                                                       class="w-9 h-9 bg-success-subtle text-success-600 rounded-full shrink-0">
                                                                                                                              <span
                                                                                                                                       class="text-base font-semibold mb-0">Koria</span>
                                                                                                                     </span>
                                                                                                            </label>
                                                                                                            <input class="form-check-input rounded-full"
                                                                                                                     name="language"
                                                                                 ...
                                                                                 <div
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                     ...
                                                                                                                     <img class="rounded-full w-11 h-11"
                                                                                                                              src="<?php echo $domain ?>assets/images/notification/profile-3.png"
                                                                                                                              alt="Joseph image">
                                                                                                                     <span
                                                                                                            ...
                                                                                                            <div>
                                                                                                                     <h6
                                                                                                                              class="text-sm fw-semibold mb-1">
                                                                                                                              Kathryn
                                                                                                                              Murphy
                                                                                                                     </h6>
                                                                                                                     <p
                                                                                                                              class="mb-0 text-sm line-clamp-1">
                                                                                                                              hey!
                                                                                                                              there
                                                                                                                              i'm...
                                                                                                                     </p>
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <span
                                                                                                                     class="text-sm text-neutral-500">12:30
                                                                                                                     PM</span>
                                                                                                            <span
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                     class="flex-shrink-0 relative">
                                                                                                                     <img class="rounded-full w-11 h-11"
                                                                                                                              src="<?php echo $domain ?>assets/images/notification/profile-4.png"
                                                                                                                              alt="Joseph image">
                                                                                                                     <span
                                                                                                                              class="absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600"></span>
                                                                                                            </div>
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                     class="flex-shrink-0 relative">
                                                                                                                     <img class="rounded-full w-11 h-11"
                                                                                                                              src="<?php echo $domain ?>assets/images/notification/profile-5.png"
                                                                                                                              alt="Joseph image">
                                                                                                                     <span
                                                                                                                              class="absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600"></span>
                                                                                                            </div>
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                     class="flex-shrink-0 relative">
                                                                                                                     <img class="rounded-full w-11 h-11"
                                                                                                                              src="<?php echo $domain ?>assets/images/notification/profile-6.png"
                                                                                                                              alt="Joseph image">
                                                                                                                     <span
                                                                                                                              class="absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600"></span>
                                                                                                            </div>
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                     class="flex-shrink-0 relative">
                                                                                                                     <img class="rounded-full w-11 h-11"
                                                                                                                              src="<?php echo $domain ?>assets/images/notification/profile-7.png"
                                                                                                                              alt="Joseph image">
                                                                                                                     <span
                                                                                                                              class="absolute end-[2px] bottom-[2px] w-2.5 h-2.5 bg-success-500 border border-white rounded-full dark:border-gray-600"></span>
                                                                                                            </div>
                                                                                 ...
                                                                                 <div
                                                                                          ...
                                                                                          <a href="javascript:void(0)"
                                                                                                   ...
                                                                                                   <div
                                                                                                            class="shrink-0">
                                                                                                            <span
                                                                                                                     class="text-sm text-neutral-500">23
                                                                                                                     Mins
                                                                                                                     ago</span>
                                                                                                   </div>
                                                                                          </a>
                                                               ...
                                                               <button data-dropdown-toggle="dropdownProfile"
                                                                        ...
                                                                        type="button">
                                                                        <img src="<?php echo $domain ?>assets/images/user.png" alt="image"
                                                                        ...
                                                                        <div
                                                                                 ...
                                                                                 <div>
                                                                                          <h6
                                                                                                   ...
                                                                                                   Shahidul Islam</h6>
                                                                                          <span
                                                                                                   class="text-neutral-500">Admin</span>
                                                                                 </div>
                                                                                 <button type="button"
                                                                                 ...
                                                                                 <ul class="flex flex-col">
                                                                                          <li>
                                                                                                   <a class="text-black px-0 py-2 hover:text-primary-600 flex items-center gap-4"
                                                                                                            href="<?php echo $domain ?>app/user-profile/">
                                                                                                            <iconify-icon
